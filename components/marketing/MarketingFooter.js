...
export default function MarketingFooter() {
  return <footer className='mk-footer'>
    <div className='mk-container'>
      ...
      <div className='mk-footer__bottom'><span>© {new Date().getFullYear()} Velakron LLC</span><div><Link href='/privacy'>Privacy</Link><Link href='/terms'>Website terms</Link><Link href='/confidentiality-terms'>Confidentiality terms</Link><Link href='/acceptable-use'>Acceptable use & data restrictions</Link></div></div>
    </div>
  </footer>
}
