...
export function FinalCta({ title = 'Spend less time asking where your parts are.', children = 'Start with a production workflow and a few participating suppliers. We’ll help you define a useful Early Access scope.', href = '/early-access', action = 'Apply for Early Access' }) {
