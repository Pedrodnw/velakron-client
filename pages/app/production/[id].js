...
const ProductionRecordDetail = () => {
  ...
  return <>
    ...
    <div className='productionStatusStrip'>
      ...
      <div><span>Stage</span><StatusBadge tone='neutral'>{formatLabel(record.current_stage || 'Not assigned')}</StatusBadge></div>
