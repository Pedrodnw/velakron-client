...
export const productMedia = {
  ...
  worklist: figure('oem-worklist', 'OEM production worklist with supplier, stage, and schedule information.', 'Find the production commitments that need a closer look.'),
  ...
  supplier: figure('supplier-worklist', 'Supplier worklist showing production commitments for connected OEM customers.', 'One place to keep connected customers informed about their work.'),
  update: figure('supplier-update', 'Supplier production update showing the information shared with the OEM.', 'Report progress on the record both companies use.'),
  ...
  history: figure('production-history', 'Production history retaining updates and handoff events.', 'A record of the updates and decisions that brought the work here.'),
}
